    ...
    <section className="py-16 sm:py-24 bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12 sm:mb-16">
          ...
          Trusted by leading organizations across various industries.SP TECHNOLOGIES has major reputed companies in their client list, spanning various industries and sectors
          </p>
        </div>
